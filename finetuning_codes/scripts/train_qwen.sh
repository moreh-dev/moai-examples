...
TRANSFORMERS_VERBOSITY=info accelerate launch \
    --config_file /nas/team_cx/jingee/ambre-models/finetuning_codes/config.yaml \
    /nas/team_cx/jingee/ambre-models/finetuning_codes/train.py \
    --model Qwen/Qwen-14B \
    ...
    --max-steps 100 \
    --log-interval 2 \
    --save-path /nas/team_cx/jingee/ambre-models/checkpoints/qwen_finetuned_$current_time \
